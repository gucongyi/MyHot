...
{
    unsafe class ILRuntime_Runtime_Stack_StackObject_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            Type type = typeof(ILRuntime.Runtime.Stack.StackObject);

            app.RegisterCLRCreateDefaultInstance(type, () => new ILRuntime.Runtime.Stack.StackObject());
