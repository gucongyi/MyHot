...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Reflection_MethodBase_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_IsGenericMethodDefinition_0);


        }


        static StackObject* get_IsGenericMethodDefinition_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
