...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ILRuntime_Reflection_ILRuntimeWrapperType_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_CLRType_0);
            args = new Type[]{};
            method = type.GetMethod("get_RealType", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_RealType_1);


        }


        static StackObject* get_CLRType_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
