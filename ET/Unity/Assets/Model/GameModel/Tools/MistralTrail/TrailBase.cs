...
namespace Mistral.Effects.Trail
{
	...
	public abstract class TrailBase : MonoBehaviour
    {
        ...
        public bool clearPointsOnDisable = true;
		...
		{ 
            if(meshFilter!=null&& activeTrail!=null)
                meshFilter.mesh = activeTrail.mesh;
        }

        private void OnDisable()
        {
            if (clearPointsOnDisable)
            {
                this.activeTrail.points.Clear();
            }
        } 
